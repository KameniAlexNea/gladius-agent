...
from src.roles import ROLE_CATALOG
from src.roles.agent_runner import run_agent
from src.roles.helpers import build_runtime_agents, get_runtime_model
from src.roles.specs import (
    ...
    if platform == "fake":
        return {
            "fake": {
                "type": "stdio",
                "command": sys.executable,
                "args": ["-m", "src.tools.fake_platform_tools"],
            }
        }
    return {}
