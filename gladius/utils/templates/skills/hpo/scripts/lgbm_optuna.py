...
if __name__ == "__main__":
    ...
    study.optimize(lambda t: objective_lgbm(t, X, y), n_trials=N_TRIALS, show_progress_bar=True)
    ...
    print("\nTop 10 trials:")
    print(df_trials.sort_values("value", ascending=(METRIC_DIRECTION == "minimize")).head(10).to_string())
