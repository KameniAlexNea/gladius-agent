...
def add_frequency_encoding(df: pd.DataFrame, col: str, train_df: pd.DataFrame | None = None) -> pd.DataFrame:
...
def add_rare_grouping(df: pd.DataFrame, col: str, min_count: int = 50, label: str = "__RARE__") -> pd.DataFrame:
